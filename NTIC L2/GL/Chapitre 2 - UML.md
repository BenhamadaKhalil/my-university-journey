# 1. Introduction to Software Engineering (Génie Logiciel)

#GL

- **Definitions and Quality of Software**: Software engineering aims to produce high-quality software through defined processes.
- **Software Crisis**: The challenges faced due to growing complexity and demands on software.
- **Development Process**: Steps involved in developing software from planning to implementation.

# 2. Object-Oriented Modeling

- **What is Modeling?**
    - **Model**: An abstract representation of a real-world system.
    - **Modeling**: The process of creating a representative model to simplify complex systems.
    - **Abstraction**: Focusing on important aspects of a system while ignoring irrelevant details.
    - **Design**: Describing the future software system.

# 3. Objectives and Languages of Modeling

- **Languages**:
    - **Formal**: Rigorous and mathematical, used for verification (e.g., Z, VDM).
    - **Semi-formal**: Flexible, such as UML and pseudo-code, allowing for easy understanding.
    - **Informal**: Natural language, easy to use but lacks precision.
- **Functional Decomposition**: Breaking down the system's functions to understand how data is represented and processed.

# 4. Object-Oriented Concepts

- **Class**: A group of similar objects.
- **Object**: Defined by identity, state, and behavior.
- **Key Principles**:
...
- UML is a visual language used for specifying, constructing, and documenting software systems.
- **UML 1.0**: Initial version released in 1997.
- **UML 2.0**: Expanded to include 14 diagrams, providing a detailed representation of software systems.

# 6. Types of UML Diagrams

- **Static Models**:
    - **Class Diagram**: Represents the static structure.
    - **Object Diagram**: Represents the objects in a system at a specific moment.
- **Dynamic Models**:
    - **Activity Diagram**: Shows workflow and actions.
    - **Sequence Diagram**: Illustrates interactions between objects over time.

# 7. Applications of UML

- **Analysis and Specification**: Understanding and defining user needs and software behavior.
- **Design**: Detailed system structure and object interactions.

# 8. SysML vs. UML

- **SysML** is a variant of UML, aimed at modeling complex systems that involve mechanical, electronic, and software components.

# 9. UML vs. UP (Unified Process)

- **UML** is not a methodology but a tool for modeling.
- **UP (Unified Process)** is a methodology that supports iterative and incremental software development.
